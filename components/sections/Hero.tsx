            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-white/20">
                ...
                <p className="text-xs mt-1">
                  WebGL required for interactive experience
                </p>
              </div>
            </div>
          }
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 py-20 text-center">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-2xl lg:text-3xl text-white/70 font-light tracking-wide mb-8 max-w-4xl mx-auto"
          >
            Full-Stack Developer <span className="text-primary">•</span>{' '}
            Cloud & DevOps <span className="text-primary">•</span> AI Builder
          </motion.p>
          ...
          >
            Building practical software from the application layer to the
            cloud, with a focus on full-stack development, cloud-native
            technologies, and DevOps. I enjoy understanding how software is
            built, deployed, and connected, while exploring AI-powered tools
            that make the development process smarter and more efficient.
          </motion.p>
