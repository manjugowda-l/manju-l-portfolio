...
const navigation = [
  ...
  { name: 'Build Dev Notes', href: '#build-dev-notes' },
  { name: 'Activities', href: '#leadership' },
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link
            href="/"
            className="font-mono text-lg font-semibold tracking-wide text-primary"
          >
            MANJU
          </Link>
        ...
        {mobileMenuOpen && (
          <div
            id="mobile-menu"
            className="md:hidden py-4 border-t border-white/5 glass"
          >
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-white/40 font-mono">
            MANJU L — Full-Stack Developer • Cloud & DevOps • AI Builder
          </p>
          ...
          <div className="flex items-center gap-6 text-sm text-white/40">
            ...
            <Link
              href="mailto:manjugowda200523@gmail.com"
              className="hover:text-primary transition-colors"
            >
              Email
            </Link>
